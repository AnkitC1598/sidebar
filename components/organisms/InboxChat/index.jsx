...
const InboxChat = () => {
	...
	return (
		<>
			<ul className="flex w-full flex-col-reverse overflow-hidden overflow-y-scroll h-navScreen h-screen-ios scrollbar-hide space-y-2 space-y-reverse p-4 bg-slate-100 dark:bg-neutral-900">
